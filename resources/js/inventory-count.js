    ...
    axios.post('/inventory-search', {
        ...
        .then(function (response) {
            ...
            parts.forEach((part) => {
                ...
                let count = makeCell(`<input type='text' name='count' id='count${part['id']}' class='count text-right px-2 py-0 mx-auto block rounded-sm border-gray-600' style='width:80px;' value='${part['count']}' onfocus="this.value=''"/>`);
