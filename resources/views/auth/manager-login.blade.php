<x-layout>
    ...
    <div class="max-w-7xl p-16 text-center bg-white border border-gray-200 rounded-lg shadow-sm  dark:bg-gray-800 dark:border-gray-700 m-auto mt-20 shadow-md">
        ...
        <h5 class="mb-4 text-3xl font-bold text-gray-900 dark:text-white mt-6">Manager Login</h5>
        <p class="mb-8 text-base text-gray-500 sm:text-lg dark:text-gray-400">Login below with your email and password.  Please contact IT if you need your login information.</p>
        <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
            <form method="post" action="/manager-login" class="w-4/6 mx-auto">
                @csrf
