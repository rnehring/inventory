...
<x-layout>
    ...
    <x-layout-container class="max-w-9xl">
            ...
            <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                ...
                <div>
                    <span class="font-medium">{{ $totalParts }} Parts Imported:</span>
                    <ul class="mt-1.5 list-disc list-inside">
                        <li>Please review the imported data below for accuracy.</li>
                        <li>Save data if correct.</li>
                        <li>Please be aware: saving will replace all current production data.  If data is not correct, please update your CSV file and try again.</li>
                    </ul>
                </div>
            </div>

        <form method="post" action="/save-uploadpre">
            @csrf
