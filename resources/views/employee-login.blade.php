<x-layout>
    ...
    <div class="max-w-7xl p-16 text-center bg-white border border-gray-200 rounded-lg shadow-sm  dark:bg-gray-800 dark:border-gray-700 m-auto mt-20 shadow-md">
        ...
        <p class="mb-8 text-base text-gray-500 sm:text-lg dark:text-gray-400">Choose the company you work for from the dropdown menu, and then enter your initials. Please use 3 initials if possible.</p>

        <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">

            <form method="post" action="/login-employee" id="loginForm" class="w-4/6 mx-auto">
                @csrf
                ...
                <x-form-field fieldName="initials" labelText="Initials" required />
